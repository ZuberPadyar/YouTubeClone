...
const SearchResultVideoCard = ({ video }) => {
    return (
        ...
        >
            <m.div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4" 
            initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} transition={{duration:1, staggerChildren:0.5}}>
